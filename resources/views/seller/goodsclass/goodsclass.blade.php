...
@section('content')
            ...
            <input class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="submit" value="搜索">
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="{{ url('seller/goodsclass/'.$v->gcid.'/edit') }}">
                                                            <i class="am-icon-pencil"></i> 编辑
                                                        </a>
                                                        <a href="javascript:;" onclick="DelUser({{$v->gcid}})" class="tpl-table-black-operation-del">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        {!! $cate->appends(['keywords' => $key])->render() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script>
                ...
                function DelUser(gcid){
                    ...
                    layer.confirm('是否确认删除？', {
                        ...
                        $.post("{{url('seller/goodsclass/')}}/"+gcid,{'_method':'DELETE','_token':"{{csrf_token()}}"},function(data){
                            if(data.status == 0){

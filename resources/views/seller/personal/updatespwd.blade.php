...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
    <div class="widget am-cf">
        ...
        @endif
            <form class="am-form tpl-form-line-form" id="myform" method="post" action="{{url('/seller/personal/'.$data->sid)}}">
            {{csrf_field()}}
            <input type="hidden" name="_method" value="put">
                <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">账号</label>
                    <div class="am-u-sm-9">
                        <input type="text" style="width:200px;border: none;" disabled readonly value="{{$data->sname}}" class="tpl-form-input" id="user-name">
                        <input type="hidden" class="hid" value="{{$data->sid}}" name="sid">
				...
				<div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="password" style="width:200px" class="yspwd" name="yspwd" value=""	placeholder="请输入您的原密码"><span></span><br>
                    </div>
                </div>
                <div class="am-form-group">
                    <label class="am-u-sm-3 am-form-label">新密码</label>
                    <div class="am-u-sm-9">
                        <input type="password" style="width:200px" id="newspwd" name="newspwd" value=""	placeholder="请输入您的密码6-18位"><span></span><br>
                         <ul class="ul_1">
							<li class="li_1">弱</li>
							<li class="li_1">中</li>
							<li class="li_1">强</li>
...
<script>
	...
	var yspwd = document.getElementById('yspwd');
	var s1 = s2 = s3 = null;
	//验证原密码
	$('.yspwd').blur(function(){
		var inp = $('.yspwd').val();
		var hid = $('.hid').val();
		$.get('/seller/pwd',{inp:inp,hid:hid},function(data){

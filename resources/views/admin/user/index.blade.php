                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    @foreach($data as $k=>$v)
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" title="删除" onclick="DelUser({{$v->uid}})" style="color:#000;font-size:20px;margin-right:15px;"><i class="icon-trash"></i></a>
                                <a href="{{url('admin/user/'.$v->uid.'/edit')}}" title="修改" style="color:#000;font-size:20px;margin-right:15px;"><i class="icon-pencil-2"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
